                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ route('admins.index') }}" id="refreshPage"
                                            class="btn btn-outline-info mr-2" data-toggle="tooltip" data-placement="top"
                                            title="Segarkan">
                                            <i class="fas fa-sync-alt mr-1"></i>
                                        </a>
                                        <a href="{{ route('admins.create') }}" class="btn btn-outline-success mr-2"
                                        ...
                                        <a href="#" id="deleteAllSelectedRecord" class="btn btn-outline-danger"
                                            ...
                                            data-url="{{ route('admins.destroy.multi') }}">
                                        ...
                                        @else
                                            @foreach ($admins as $admin)
                                                <tr class="text-center" id = "upt_ids{{ $admin->id }}">
                                                    ...
                                                    <td>{{ $admin->created_at->format('d-m-Y') }}<br>{{ $admin->created_at->format('H:i:s') }}
                                                    </td>

                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a href="{{ route('admins.detail', $admin->id) }}"
                                ...
                                <ul class="pagination justify-content-center">
                                    @if ($admins->previousPageUrl())
                                        <li class="page-item"><a class="page-link"
                                                href="{{ $admins->previousPageUrl() }}">Kembali</a></li>
                                    @else
                                    ...
                                    @if ($admins->nextPageUrl())
                                        <li class="page-item"><a class="page-link"
                                                href="{{ $admins->nextPageUrl() }}">Berikutnya</a></li>
                                    @else

                           ...
                           <div class="col-md-12"> 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="latitude" id="latitude" placeholder="Latitude" readonly required value="{{ old('latitude', $busStation->latitude) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="longitude">Longitude</label>
                                    <input type="text" class="form-control" name="longitude" id="longitude" placeholder="Longitude" readonly required value="{{ old('longitude', $busStation->longitude) }}">
                                </div>
                            </div>
                        </div>

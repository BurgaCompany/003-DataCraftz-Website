                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <form action="{{ route('bus_stations.search') }}" method="GET">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="search" id="searchInput"
                                                    placeholder="Masukkan Nama Terminal" value="" size="30">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ route('bus_stations.index') }}" id="refreshPage"
                                            class="btn btn-outline-info mr-2" data-toggle="tooltip" data-placement="top"
                                            title="Segarkan">
                                            <i class="fas fa-sync-alt mr-1"></i>
                                        </a>

                                        <a href="{{ route('bus_stations.create') }}" class="btn btn-outline-success mr-2"
                                        ...
                                        <a href="#" id="deleteAllSelectedRecord" class="btn btn-outline-danger"
                                            ...
                                            data-url="{{ route('bus_stations.destroy.multi') }}">
                                            ...
                                            @foreach ($userBusStations as $userBusStation)
                                                <tr class="text-center" id = "upt_ids{{ $userBusStation->id }}">
                                                    <td><input type="checkbox" name="ids" class = "checkbox_ids"
                                                            id ="{{ $userBusStation->busStation->id }}"
                                                            value="{{ $userBusStation->id }}"></td>
                                                    ...
                                                    <td>{{ Str::limit($userBusStation->busStation->address, 50, '...') }}
                                                    </td>
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a href="{{ route('bus_stations.detail', $userBusStation->busStation->id) }}"
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a href="{{ route('bus_stations.edit', $userBusStation->busStation->id) }}"
                                ...
                                <ul class="pagination justify-content-center">
                                    @if ($userBusStations->previousPageUrl())
                                        <li class="page-item"><a class="page-link"
                                                href="{{ $userBusStations->previousPageUrl() }}">Kembali</a></li>
                                    @else
                                    ...
                                    @for ($i = 1; $i <= $userBusStations->lastPage(); $i++)
                                        <li class="page-item {{ $userBusStations->currentPage() == $i ? 'active' : '' }}">
                                            <a class="page-link"
                                                href="{{ $userBusStations->url($i) }}">{{ $i }}</a>
                                        </li>
                                    @endfor

                                    @if ($userBusStations->nextPageUrl())
                                        <li class="page-item"><a class="page-link"
                                                href="{{ $userBusStations->nextPageUrl() }}">Berikutnya</a></li>
                                    @else

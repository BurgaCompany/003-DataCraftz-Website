                                ...
                                <form method="POST" action="{{ route('busses.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    id="chair" min="0" max="99"
                                                    placeholder="Masukkan Kursi" required value="{{ old('chair') }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" name="class" id="class"
                                                    ...
                                                    <option value="Ekonomi"
                                                        {{ old('class') == 'Ekonomi' ? 'selected' : '' }}>Ekonomi</option>
                                                    <option value="Patas" {{ old('class') == 'Patas' ? 'selected' : '' }}>
                                                        Patas</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" name="status" id="status"
                                                    ...
                                                    <option value="Belum Berangkat"
                                                        {{ old('status') == 'Belum Berangkat' ? 'selected' : '' }}>Belum
                                                        Berangkat</option>
                                                    <option value="Berangkat"
                                                        {{ old('status') == 'Berangkat' ? 'selected' : '' }}>Berangkat
                                                    </option>
                                                    <option value="Terkendala"
                                                        {{ old('status') == 'Terkendala' ? 'selected' : '' }}>Terkendala
                                                    </option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" id="keteranganField"
                                            style="{{ old('status') == '4' ? 'display:block;' : 'display:none;' }}">
                                            <div class="form-group">

                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <form action="{{ route('busses.search') }}" method="GET">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="search" id="searchInput"
                                                    placeholder="Masukkan Nama Bus" value="" size="30">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ route('busses.index') }}" id="refreshPage"
                                            class="btn btn-outline-info mr-2" data-toggle="tooltip" data-placement="top"
                                            title="Segarkan">
                                            <i class="fas fa-sync-alt mr-1"></i>
                                        </a>
                                        @if (Auth::user()->hasRole('PO'))
                                            <a href="{{ route('busses.create') }}" class="btn btn-outline-success mr-2"
                                            ...
                                            <a href="#" id="deleteAllSelectedRecord" class="btn btn-outline-danger"
                                                ...
                                                data-url="{{ route('busses.destroy.multi') }}">
                                            ...
                                            @foreach ($busses as $bus)
                                                <tr class="text-center" id = "upt_ids{{ $bus->id }}">
                                                    <td><input type="checkbox" name="ids" class = "checkbox_ids"
                                                            id ="{{ $bus->id }}" value="{{ $bus->id }}"></td>
                                                    <td>{{ $bus->id }}</td>
                                                    <td>{{ $bus->name }}</td>
                                                    <td>{{ $bus->chair }}</td>
                                                    <td>{{ preg_replace('/([a-zA-Z])([0-9]+)/', '$1 $2 ', $bus->license_plate_number) }}
                                                    </td>
                                                    <td>{{ $bus->class }}</td>
                                                    <td>
                                                        {{ $bus->status }}
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a href="{{ route('busses.detail', $bus->id) }}"
                                                        ...
                                                        <div class="btn-group" role="group" aria-label="Basic example">
                                                            <a href="{{ route('busses.edit', $bus->id) }}"
                                ...
                                <ul class="pagination justify-content-center">
                                    @if ($busses->previousPageUrl())
                                        <li class="page-item"><a class="page-link"
                                                href="{{ $busses->previousPageUrl() }}">Kembali</a></li>
                                    @else
                                    ...
                                    @if ($busses->nextPageUrl())
                                        <li class="page-item"><a class="page-link"
                                                href="{{ $busses->nextPageUrl() }}">Berikutnya</a></li>
                                    @else

                                ...
                                <form method="POST" action="{{ route('busses.update', $bus->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('license_plate_number') is-invalid @enderror"
                                                    name="license_plate_number" id="license_plate_number"
                                                    placeholder="Masukkan Nomor Polisi Kendaraan" required maxlength="9"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    type = "number" maxlength = "2" class="form-control" name="chair"
                                                    id="chair" placeholder="Masukkan Kursi" required
                                                    value="{{ $bus->chair ?? old('chair') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" name="status" id="status"
                                                    style="width: 100%" onchange="showKeterangan()" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12" id="keteranganField"
                                            style="{{ old('status', $bus->status) == '4' ? 'display:block;' : 'display:none;' }}">
                                            <div class="form-group">
                                                ...
                                                @if (Auth::user()->hasRole('Upt'))
                                                    <div class="input-group-append">
                                                        <span class="ml-2 text-primary"
                                                            ...
                                                            onclick="location.href='{{ route('drivers.create') }}'">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" name="bus_conductors[]"
                                                    ...
                                                    title="Pilih satu atau lebih kondektur">
                                                ...
                                                @if (Auth::user()->hasRole('Upt'))
                                                    <div class="input-group-append">
                                                        <span class="ml-2 text-primary"
                                                            style="font-size: 12px; cursor: pointer;"
                                                            onclick="location.href='{{ route('bus_conductors.create') }}'">
                                    ...
                                    <div class="modal fade" id="exampleModalInvalid" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabelInvalid" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Anda harus memilih setidaknya satu sopir dan satu konduktor sebelum
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-dismiss="modal">Batal</button>
                                                    <a href="{{ route('busses.index') }}" class="btn btn-primary">Ya,
                                                        Kembali</a>
                                                </div>
                                            </div>
                                        </div>

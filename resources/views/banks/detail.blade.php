                                ...
                                <form method="POST" action="{{ route('banks.update', $bank->id) }}"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="account_name"
                                                    ...
                                                    value="{{ old('account_name', $bank->account_name) }}" disabled>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="type_bank" id="type_bank"
                                                    ...
                                                    value="{{ old('type_bank', $bank->type_bank) }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Konfirmasi Perubahan Data
                                                    </h5>
                                                </div>
                                                <div class="modal-body">

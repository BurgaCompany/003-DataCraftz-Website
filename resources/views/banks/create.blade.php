                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="account_name" id="account_name" placeholder="Masukkan Nama" required value="{{ old('account_name') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="type_bank" id="type_bank" placeholder="Masukkan Jenis Bank" required value="{{ old('type_bank') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="account_number">Nomor Rekening</label>
                                            <input type="text" class="form-control" name="account_number" id="account_number" placeholder="Masukkan Nomor Rekening" required value="{{ old('account_number') }}" maxlength="20">
                                        </div>
                                    </div>
                                </div>

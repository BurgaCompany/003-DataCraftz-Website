                    ...
                    <div class="col-xl">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('bus_conductors.update', $bus_conductor->id) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name"
                                                    ...
                                                    value="{{ old('name', $bus_conductor->name) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email"
                                                    ...
                                                    value="{{ old('email', $bus_conductor->email) }}" required>
                                                @error('email')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="address" id="address"
                                                    placeholder="Alamat"
                                                    value="{{ old('address', $bus_conductor->address) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" name="gender" id="gender"
                                                    ...
                                                    @foreach ($genders as $key => $value)
                                                        <option value="{{ $key }}"
                                                            {{ old('gender', $bus_conductor->gender) == $key ? 'selected' : '' }}>
                                                            {{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('phone_number', $bus_conductor->phone_number) }}" required
                                                ...
                                                <select class="js-states form-control" name="level" id="level"
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <option value="{{ $role->id }}"
                                                            @if ($role->name === 'Bus_Conductor') selected @endif>
                                                            {{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>

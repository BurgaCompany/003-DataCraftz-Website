                    ...
                    <div class="col-xl">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('otobuses.update', $otobus->id) }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name"
                                                    placeholder="Masukkan Nama" value="{{ old('name', $otobus->name) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="email"
                                                    ...
                                                    value="{{ old('email', $otobus->email) }}" required>
                                                @error('email')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="address" id="address"
                                                    placeholder="Alamat" value="{{ old('address', $otobus->address) }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" name="gender" id="gender"
                                                    ...
                                                    @foreach ($genders as $key => $value)
                                                        <option value="{{ $key }}"
                                                            {{ old('gender', $otobus->gender) == $key ? 'selected' : '' }}>
                                                            {{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('phone_number', $otobus->phone_number) }}" required
                                                ...
                                                <select class="js-states form-control" name="level" id="level"
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <option value="{{ $role->id }}"
                                                            @if ($role->name === 'PO') selected @endif>
                                                            {{ $role->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-dismiss="modal">Batal</button>
                                                    <a href="{{ route('otobuses.index') }}" class="btn btn-primary">Ya,
                                                        Kembali</a>
                                                </div>
                                            </div>
                                        </div>

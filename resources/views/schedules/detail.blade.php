                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" name="frombusStations[]"
                                                    id="departureTerminal" style="width: 100%" disabled>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="js-states form-control" name="tobusStations[]"
                                                    id="arrivalTerminal" style="width: 100%" disabled>
                                                    @foreach ($busStations as $busStation)
                                                        <option value="{{ $busStation->id }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="price" id="price"
                                                        ...
                                                        value="{{ old('price', $schedules->price) }}" min="0"
                                                        @if ($buss->class == 'Patas') @else
                                                        oninput="validatePrice()" @endif
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control" name="time_start" id="time_start"
                                                    required value="{{ $schedules->time_start }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control" name="time_arrive"
                                                    id="time_arrive" required value="{{ $schedules->time_arrive }}"
                                                    disabled>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('schedules.index') }}" class="btn btn-primary">Ya,
                                                        Kembali</a>
                                                </div>
                                            </div>
                                        </div>

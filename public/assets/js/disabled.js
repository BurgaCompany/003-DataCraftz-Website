$(document).ready(function () {
    ...
    $("#saveButton").hide();
    $("#cancelButton").hide();
    // Menjadikan select admin menjadi disabled saat halaman dimuat
    ...
    $("#editButton").click(function () {
        ...
        $("#name, #code_name, #city, #address").prop("disabled", false);
    ...
    $("#cancelButton").click(function () {
        ...
        $("#name, #code_name, #city, #address").prop("disabled", true);
